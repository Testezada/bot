...
limitt = 50
ban = ["@s.whatsapp.net",]
userpremium = ["558194687636@s.whatsapp.net","559885018147@s.whatsapp.net"] //ubah nomer kalian
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '⌛ Aguarde alguns segundos, estou fazendo ⌛',
				success: '✔️ Sucesso ✔️',
		...
		client.sendMessage(from, bahasa(prefix, sender), text, {quoted: mek})
               ...
               break
				...
				ben = '```Lista dos Banidos``` :\n'
					...
					case 'listaprem':
				prem = 'Lista Usuarios Premium  TIO VRAU BOT\n\n'
	      ...
	      tels = body.slice(6)
              ...
              break
                ...
                case 'imagem':
					...
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
			        ban = mentioned
					reply(`vc esta proibido de usar o bot: ${ban}`)
					break
						case 'addprem':
					client.updatePresence(from, Presence.composing)
					if (args.length < 1) return
					...
					reply(`*agora vc e premium ${addpremium} vc agora tem comandos premium*\n\nvc agora tem privilegios no bot:)`)
					break
				case 'kickprem':
					if (!isOwner) return reply(mess.only.ownerB)
					rprem = body.slice(13)
